...
export default function EncadrantGroupDocumentsPage() {
  ...
  return (
    <div className="container mx-auto py-4 px-4 md:py-8 md:px-6 lg:px-8">
      <Card className="w-full max-w-3xl mx-auto shadow-lg border-0 overflow-hidden bg-gradient-to-b from-background to-muted/20">
        ...
        <CardContent className="p-0">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value={activeTab} className="p-4 md:p-6 space-y-6">
              ...
              {isLoading ? (
                ...
                <div className="space-y-4">
                  {filteredDocuments.map((doc) => (
                    ...
                    >
                      <div className="flex flex-col md:flex-row md:items-center justify-between p-4 bg-muted/20 border-b border-border/30 gap-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                          <Button variant="outline" size="sm" asChild className="h-8 text-xs">
                            <a href={`${API_BASE_URL}${doc.fichier}`} download={doc.fichier.split("/").pop()}>
        ...
        <CardFooter className="p-4 border-t border-border/40 bg-muted/30 flex flex-col sm:flex-row justify-between gap-2">
          <p className="text-xs text-muted-foreground">ID Encadrant: {idEncadrant}</p>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <DialogFooter className="flex flex-col-reverse sm:flex-row justify-between sm:justify-between gap-2">
            ...
            <div className="flex gap-2">
              <Button variant="outline" onClick={closeValidationForm} type="button">
                Annuler
              </Button>
