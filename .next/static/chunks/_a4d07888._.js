(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_a4d07888._.js", {
    ...
    const submitValidation = async ()=>{
        ...
        try {
            ...
            if (response.ok) {
                ...
                setFetchError(`Failed to submit validation: ${errorData.error || "Unknown error"}`);
            }
        } catch (error) {
            console.error("Error submitting validation:", error);
            setFetchError("Error connecting to server during validation submission");
        }
    };
    const deleteValidation = async ()=>{
        ...
        try {
            ...
            if (response.ok) {
                ...
                const errorData = await response.json();
                setFetchError(`Failed to delete validation: ${errorData.error || "Unknown error"}`);
            }
        } catch (error) {
            console.error("Error deleting validation:", error);
            setFetchError("Error connecting to server during validation deletion");
        }
    };
...
//# sourceMappingURL=_a4d07888._.js.map